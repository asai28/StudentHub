...
export default {
  ...
  getAdzunaJobs: () => {
    return axios.get(
      "http://api.adzuna.com/v1/api/jobs/gb/search/1?app_id=17711746&app_key=cd7075866de3337b020259dba06d0b68&results_per_page=20&what=javascript%20developer&content-type=application/json"
    );
  },
